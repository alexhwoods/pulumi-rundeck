...
class Provider(pulumi.ProviderResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] api_version: API Version of the target Rundeck server.
        :param pulumi.Input[str] auth_token: Auth token to use with the Rundeck API.
        :param pulumi.Input[str] url: URL of the root of the target Rundeck server.
        """
