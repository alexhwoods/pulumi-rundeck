...
namespace Pulumi.Rundeck.Inputs
{
    ...
    public sealed class RundeckJobCommandJobGetArgs : Pulumi.ResourceArgs
    {
        [Input("args")]
        ...
        [Input("nodefilters")]
        public Input<Inputs.RundeckJobCommandJobNodefiltersGetArgs>? Nodefilters { get; set; }

        [Input("runForEachNode")]
        public Input<bool>? RunForEachNode { get; set; }

        public RundeckJobCommandJobGetArgs()
        {
        }
    }
}
